...
\begin{center}
	\schemestart
		...
		\chemfig{
			C(-[:90]H)(-[:270]H)(-[:180]H)-C(-[:90]H)(-[:270]H)(-[:0]O-H)
		}
	\schemestop
\end{center}
\begin{center}
...
functional group is \chemfig[atom sep=0.5cm]{NH_2-}; that for carboxylic acids is \chemfig[atom sep=0.5cm]{-COOH} and alcohols have
\chemfig[atom sep=0.5cm]{-OH} as their functional group. For polymers formed through condensation, there are three
different monomers:
...
acid group loses \chemfig[atom sep=0.5cm]{-OH}, and the alcohol and amine groups lose 
\chemfig[atom sep=0.6cm]{-H}.
...
\begin{center}
	\schemestart
	\chemfig[atom sep=0.7cm]{C(=[:135]O)(-[:225]O(-[:180]H))-R-C(-[:45]O)(-[:315]O-H)}
	+
	\chemfig[atom sep=0.7cm]{N(-[:135]H)(-[:225]H)-R'-N(-[:45]H)(-[:315]H)}
	\ce{->}
	\chemfig[atom sep=0.7cm]{C(=[:90]O)(-[:180]N(-[:90]H)(-[:180]R'-[:180]))-R-C(=[:90]O)(-[:0]N(-[:90]H)(-R'-))}
	\schemestop
\end{center}
where,
\begin{center}
	\schemestart
	\chemfig{-N(-[:90]H)-C(=[:90]O)-}
	\schemestop
\end{center}
is an amide linkage.

\textbf{Polyesters.} The condensation polymerisation of dicarboxylic acids with diols form 
polyesters.
\begin{center}
	\schemestart
	\chemfig[atom sep=0.7cm]{C(=[:135]O)(-[:225]O(-[:180]H))-R-C(-[:45]O)(-[:315]O-H)}
	+
	\chemfig[atom sep=0.7cm]{H-O-R'-O-H}
	\ce{->}
	\chemfig[atom sep=0.7cm]{C(=[:90]O)(-[:180]O(-[:180]R'-[:180]))-R-C(=[:90]O)(-[:0]O(-R'-))}
	\schemestop
\end{center}
where,
\begin{center}
...
\chemfig[atom sep=0.5cm]{C=C} bond. Only the polymer is formed as the single product, which is
...
\begin{center}
	\chemfig[atom sep=0.7cm]{-C(=[:90]O)-R-C(=[:90]O)-N(-[:270]H)-R'-N(-[:270]H)-C(=[:90]O)-R-C(=[:90]O)-N(-[:270]H)-R'-N(-[:270]H)-C(=[:90]O)-R-}
\end{center}
...
\begin{center}
	\chemfig{N(-[:135]H)(-[:225]H)-C(-[:90]R)(-[:270]H)-C(=[:45]O)(-[:315]O-H)}
\end{center}
...
\begin{center}
	\chemfig{
	-N(-[:90]H)-R-C(=[:90]O)-N(-[:270]H)-R'-C(=[:270]O)-N(-[:90]H)-R''-C(=[:90]O)-
	}
\end{center}
